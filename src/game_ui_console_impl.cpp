...
void GameUiConsoleImpl::create_window()
{
    ...
    const int display_width_chr{
        this->display_width_dot * this->dot_width_chr
    }; 
    const int display_height_chr{
        this->display_height_dot * this->dot_height_chr
    };
...
void GameUiConsoleImpl::set_pixel(int x_dot, int y_dot, Color color)
{
    ...
    const int x_chr{x_dot * this->dot_width_chr};
    const int y_chr{y_dot * this->dot_height_chr};
...
void GameUiConsoleImpl::draw_border()
{
    ...
    const int game_board_width_dot{
        this->pixel_size_dot * this->game_board_width_px
    };
